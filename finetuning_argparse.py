...
def init_args():
    ...
    # Base parameters
    parser.add_argument("--data_path", default='./MRC-CLRI-TAO/data_tao/sentfin/', type=str,  help="The path of data")
    ...
    parser.add_argument("--model_path", default= "bert-base-uncased",  type=str, help="Path to pre-trained model")

    parser.add_argument("--output_dir", default='./MRC-CLRI-TAO/outputs/saves', type=str, help="The dir of results")
    parser.add_argument('--log_dir', default="./MRC-CLRI-TAO/outputs/logs", type=str, help="The dir of logs")
    parser.add_argument('--save_path', default="", type=str)
    # parser.add_argument('--checkpoint_path', default="./MRC-CLRI-TAO/outputs/saves/ASQE/review/1668339564_modeltest.pth", type=str,
